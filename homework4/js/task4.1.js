...
//   const unique = skills.filter((skill, index, uniqueSkills) => uniqueSkills.indexOf(skill) === index)
//   unique.sort()
//   return unique
// }
...
users
  ...
  .filter((skill, index, uniqueSkills) => uniqueSkills.indexOf(skill) === index)
  .sort();
